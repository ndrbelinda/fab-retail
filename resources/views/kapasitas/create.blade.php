    ...
    <form action="{{ route('kapasitas.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input 
                ...
                class="mt-1 block w-64 rounded-md border-gray-300 shadow-sm h-10 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 
                @error('besar_kapasitas') border-red-500 @enderror" required
                max="999999999" 
