...
<x-layout>
    ...
    <!-- Form Input -->
    <form action="{{ route('perangkat.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="jenis_perangkat" id="jenis_perangkat" value="{{ old('jenis_perangkat') }}" class="mt-1 block w-64 rounded-md border-gray-300 shadow-sm h-10 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 @error('jenis_perangkat') border-red-500 @enderror" required>
        ...
        <div>
            ...
            <input type="file" name="gambar_perangkat" id="gambar_perangkat" class="mt-1 block w-64 rounded-md border-gray-300 shadow-sm h-10 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 @error('gambar_perangkat') border-red-500 @enderror" accept="image/*" required>
        ...
        <div>
            ...
            <input type="number" name="tarif_perangkat" id="tarif_perangkat" value="{{ old('tarif_perangkat') }}" class="mt-1 block w-64 rounded-md border-gray-300 shadow-sm h-10 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 @error('tarif_perangkat') border-red-500 @enderror" required>
        ...
        <div>
            ...
            <textarea name="deskripsi_perangkat" id="deskripsi_perangkat" rows="4" class="mt-1 block w-64 rounded-md border-gray-300 shadow-sm px-3 py-2 focus:border-blue-500 focus:ring-blue-500">{{ old('deskripsi_perangkat') }}</textarea>
